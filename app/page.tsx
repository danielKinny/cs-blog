      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="bg-white p-6 rounded-lg shadow-md animate-slide-in-left transform transition-all duration-300 hover:scale-105 hover:shadow-lg" style={{animationDelay: '0.2s', animationFillMode: 'forwards', opacity: 0}}>
              ...
              <h3 className="text-xl text-black font-semibold mb-3">Algorithms & Data Structures</h3>
              <p className="text-black">
                Master the fundamentals with clear explanations and practical examples.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md animate-slide-in-left transform transition-all duration-300 hover:scale-105 hover:shadow-lg" style={{animationDelay: '0.4s', animationFillMode: 'forwards', opacity: 0}}>
              ...
              <h3 className="text-xl text-black font-semibold mb-3">Programming Tutorials</h3>
              <p className="text-black">
                Learn modern programming languages and frameworks with hands-on guides.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md animate-slide-in-left transform transition-all duration-300 hover:scale-105 hover:shadow-lg" style={{animationDelay: '0.6s', animationFillMode: 'forwards', opacity: 0}}>
              ...
              <h3 className="text-xl text-black font-semibold mb-3">Performance & Optimization</h3>
              <p className="text-black">
                Discover techniques to write efficient, scalable, and maintainable code.
              </p>
            </div>
          </div>
        </div>
