      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in-delay">
            ...
            <a className="bg-white p-6 rounded-lg shadow-md animate-slide-in-left transform transition-all duration-300 hover:scale-105 hover:shadow-lg" style={{animationDelay: '0.4s', animationFillMode: 'forwards', opacity: 0}} href="/courses">
              ...
              <h3 className="text-xl text-black font-semibold mb-3">Explore Recommended Courses</h3>
              <p className="text-black">
            ...
            <a className="bg-white p-6 rounded-lg shadow-md animate-slide-in-left transform transition-all duration-300 hover:scale-105 hover:shadow-lg" style={{animationDelay: '0.6s', animationFillMode: 'forwards', opacity: 0}} href="/cis">
